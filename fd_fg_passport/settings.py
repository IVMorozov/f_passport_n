"""
Django settings for fd_fg_passport project.
...
SECRET_KEY = 'django-insecure-u3g=e-hx-p_p$=s$*ty2$+=8%*^=+v_2vn!+5*1^(m3y4a%q8l'
...
ROOT_URLCONF = 'fd_fg_passport.urls'
...
WSGI_APPLICATION = 'fd_fg_passport.wsgi.application'
